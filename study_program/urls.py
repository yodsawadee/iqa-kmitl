...
urlpatterns = [
    ...
    path('iqa_menu/committee_recommendation/recalculate', views.combine_recommendation ,name='recalculate_committee_recommendation'),
    ...
    path('faculty_study_program/export/csv', views.export_faculty_studyprogram_csv, name = 'export_faculty_studyprogram_csv'),
