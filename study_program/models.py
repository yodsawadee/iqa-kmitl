...
class Committee(models.Model):
    ...
    def __str__(self):
        return str(self.year) + " : " + str(self.professor_id.name_surname) 
...
class AssessmentResult(models.Model):
    ...
    #committee_id = models.ManyToManyField(Professor, through='Committee.professor_id.name_surname')
    ...
    def __str__(self):
        return str(self.year) +" : "+str(self.program_id.name)
...
class RecommendedCommittee(models.Model):
    program_name = models.CharField(max_length=200, blank=True)
    committee1 = models.CharField(max_length=200, blank=True)
    committee2 = models.CharField(max_length=200, blank=True)
    committee3 = models.CharField(max_length=200, blank=True)
    committee4 = models.CharField(max_length=200, blank=True)
